"""
=====================================================================
WORKER (UNIVERSAL FIX - WORKS WITH ALL TRANSFORMERS VERSIONS)
=====================================================================
Replace your ENTIRE worker code with this
Works for both Worker 1 and Worker 2 - just change the config
=====================================================================
"""
...
# ============= STEP 3: CONFIG =============
# FOR WORKER 1: Use these values
MODEL_NAME = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"
LAYER_START = 0
LAYER_END = 11
WORKER_NAME = "Worker 1"
WORKER_PORT = 5001
NGROK_TOKEN = "YOUR_WORKER_1_NGROK_TOKEN"

# FOR WORKER 2: Change to these values
# LAYER_START = 11
# LAYER_END = 22
# WORKER_NAME = "Worker 2"
# WORKER_PORT = 5002
# NGROK_TOKEN = "your_worker_2_token"
...
def home():
    ...
    <body style="font-family:Arial;padding:40px;background:#e3f2fd;">
...
def health():
    return jsonify({
        "status": "healthy",
        "role": WORKER_NAME.lower().replace(" ", "_"),
...
def process():
    ...
    try:
        ...
        return jsonify({
            ...
            "status": "success",
            "worker": WORKER_NAME.lower().replace(" ", "_")
        })
